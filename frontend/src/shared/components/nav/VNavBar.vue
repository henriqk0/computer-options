    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center space-x-4">
          <VEntityMenu v-if="isAdmin" :entity="'Usuários'" :url="'/users'" />
          <VEntityMenu :entity="'Componentes'" :url="'/components'" />
    ...
    <div v-show="mobileOpen" class="md:hidden border-t border-gray-200 dark:border-neutral-700">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <button
          ...
          @click="mobileUsersOpen = !mobileUsersOpen"
        >
          <div class="flex items-center">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
              <path
            ...
            <span class="px-3 text-gray-700 dark:text-white">Usuários</span>
          </div>

          <svg
            class="w-4 h-4 transform transition-transform"
            :class="{ 'rotate-180': mobileUsersOpen }"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div
          v-show="mobileUsersOpen"
          class="pl-4 mt-1 space-y-1 text-sm text-gray-600 dark:text-white"
        >
          <RouterLink to="/users" class="block px-3 py-2">Listar Usuários</RouterLink>
        </div>
...
import VEntityMenu from './VEntityMenu.vue'
...
const isAdmin = computed(() => auth.requiresAdmin.value)
