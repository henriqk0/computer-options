<template>
  <div
    class="rounded-lg shadow-lg overflow-hidden mb-8 border border-gray-200 dark:bg-neutral-800 dark:border-neutral-700"
  >
    <div class="md:flex">
      ...
      <div class="p-8 flex-1">
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
          <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2 dark:text-neutral-100">
              {{ component.nameComponent }}
            </h1>
            <p class="text-lg text-gray-600 dark:text-neutral-400">{{ categoryLabel }}</p>
          </div>
          ...
          <div class="mt-4 md:mt-0 text-right">
            ...
            <p class="text-sm text-gray-500 mt-1 dark:text-neutral-500">
        ...
        <!-- Description -->
        <div class="mb-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-3 dark:text-neutral-100">Descrição</h3>
          <span class="text-gray-700 text-sm dark:text-neutral-300">{{ component.about }}</span>
        </div>

        <!-- Rating Summary -->
        <div class="flex items-center mb-6 pb-6 border-b border-gray-200 dark:border-neutral-700">
          <div class="flex items-center">
            ...
            <span class="text-3xl font-bold text-gray-900 ml-2 dark:text-neutral-100">{{
              formatNumber(averageScore)
            }}</span>
            <span class="text-gray-600 text-sm ml-3 dark:text-neutral-400">
