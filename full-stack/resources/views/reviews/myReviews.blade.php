...
<body>
    ...
    <!-- Modal for Edit/Delete Review -->
    <div id="manipulateModal" class="hidden fixed inset-0 bg-white z-50 only-auth">
                    ...
                    <form id="reviewForm" class="space-y-8">
                        ...
                        <div>
                            <textarea id="reviewContent" name="content" required rows="15"
                                ...
                                placeholder="Conte sua experiência e conhecimento do componente..."></textarea>
                        </div>
                    </form>
                </div>
            </div>
